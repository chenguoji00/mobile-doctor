  ...
  <div class="app-container">
    <ZKPage :header="true"
      ...
      <template slot="container">
        ...
        <van-tabs v-model="active" sticky swipeable @click="clickcurrent">
          <van-tab v-for="(item,index) in list" :title="item.label" >
            <div style="height:100%;"  v-if="index == 0">
              <PatientPage></PatientPage>
            </div>
            <div style="height:100%;"  v-if="index == 1">
              <LongMedical></LongMedical>
            </div>
            <div style="height:100%;"   v-if="index == 2">
              <TemporaMedical></TemporaMedical>
            </div>
            <div style="height:100%;"   v-if="index == 3">
              <MedicalRecord></MedicalRecord>
            </div>
            <div style="height:100%;"   v-if="index == 4">
              <ExamineReport></ExamineReport>
            </div>
            <div style="height:100%;"   v-if="index == 5">
              <temperatureSheet></temperatureSheet>
            </div>
            <div style="height:100%;"   v-if="index == 6">
              <NursingRecord></NursingRecord>
            </div>
            <div style="height:100%;"   v-if="index == 7">
              <HospitalConsultation></HospitalConsultation>
            </div>
            <div style="height:100%;"   v-if="index == 8">
              <Surgery></Surgery>
            </div>
          </van-tab>
        </van-tabs>
