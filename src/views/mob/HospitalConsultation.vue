...
<template>
  <div class='hospital-consulation'>
    ...
    <div v-for="(item,index) in hospitalConsult" :key="index" style="background-color: #fff;">
      ...
      <div style="margin:20px 10px;">
        <span style="font-size: .4rem;">会诊结论：</span>
        {{subItem.adviceResult}}
      </div>
       <div style="margin:20px 10px;">
         <span style="font-size: .4rem;">会诊建议：</span>{{subItem.adviceTxt}}
      </div>
      </div>
    </div>
    </div>
